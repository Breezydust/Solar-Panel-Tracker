...
/** \brief Get values from NMEA data
 *
 * \param string of nmea data, gpgga_t structure with location data
 * \return void
 * \author Thomas Aziz
 * \date 03APR2019
 */
...
/** \brief Parse GPS data from NMEA input
 *
 * \param string nmea, gprmc_t structure
 * \return void
 * \author Thomas Aziz
 * \date 03APR2019
 */
